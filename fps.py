...
ground=Entity(model='plane', scale=(100, 1, 100), color=color.red, texture="red_cube",
...
gun=Entity(model="assets/gun.obj", parent=camera.ui, scale=.08, color=color.gray, position=(.3, -.2),
	rotation=(-5, -10, -10))
