...
def input(key):
	if key=="left mouse down":
		...
		Animation("assets/spark", parent=camera.ui, fps=6, scale=.1, position=(.19, -.03), loop=False)
...
ground=Entity(model='plane', scale=(100, 1, 100), color=color.gray, texture="red_cube",
...
gun=Entity(model="assets/gun.obj", parent=camera.ui, scale=.08, color=color.black, position=(.3, -.2),
	rotation=(-5, -10, -10))
